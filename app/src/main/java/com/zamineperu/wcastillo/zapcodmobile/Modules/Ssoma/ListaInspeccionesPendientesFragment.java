...
public class ListaInspeccionesPendientesFragment extends Fragment {
    ...
    public ListaInspeccionesPendientesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_lista_inspecciones_pendientes, container, false);
        inicializarObjetos();
        inicializarVariables();
        listaInspeccionesPendientesUsuario();
        return rootview;
    }
    ...
    private void listaInspeccionesPendientesUsuario()
    {
        endpointsApi.listaInspeccionesPendientesUsuario(user_id).enqueue(new Callback<ArrayList<InspeccionPlanificadaResponse>>() {
            @Override
